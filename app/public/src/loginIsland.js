...
const audio = {
  acousticness: 0.5, // amount of trees
  danceability: 0.5, // waves
  energy: 0.5, // terrain height
  instrumentalness: 0.5,
  liveness: 0.5,
  loudness: -8.615727272727272, // island size
  tempo: 100,
  valence: 0.3 // color pallete, weather?
}
...
controls.autoRotateSpeed = 2; // Adjust rotation speed (e.g., 2 degrees/sec)
controls.enableDamping = true; // Optional: for smoother rotation
controls.dampingFactor = 0.05; // Optional: adjust damping
